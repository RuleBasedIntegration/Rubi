...
(* ::Code:: *)
Int[(F_^v_)^n_.,x_Symbol] :=
  (F^v)^n/(n*Log[F]*D[v,x]) /;
FreeQ[{F,n},x] && LinearQ[v,x]


(* ::Code:: *)
Int[Px_*F_^v_,x_Symbol] :=
...
(* ::Code:: *)
Int[F_^v_*Log[d_.*x_]^n_.*(e_+h_.*(f_.+g_.*x_)*Log[d_.*x_]),x_Symbol] :=
  e*x*F^v*Log[d*x]^(n+1)/(n+1) /;
FreeQ[{F,d,e,f,g,h,n},x] && LinearQ[v,x] && EqQ[e,f*h*(n+1)] && EqQ[g*h*(n+1),D[v,x]*e*Log[F]] && NeQ[n,-1]


(* ::Code:: *)
Int[x_^m_.*F_^v_*Log[d_.*x_]^n_.*(e_+h_.*(f_.+g_.*x_)*Log[d_.*x_]),x_Symbol] :=
...
(* Int[(c_.+d_.*x_)^m_.*F_^(g_.*(e_.+f_.*x_))/(a_+b_.*F_^(h_.*(e_.+f_.*x_))),x_Symbol] :=
  1/b \[Star] Int[(c+d*x)^m*F^((g-h)*(e+f*x)),x] - 
  a/b \[Star] Int[(c+d*x)^m*F^((g-h)*(e+f*x))/(a+b*F^(h*(e+f*x))),x] /;
FreeQ[{F,a,b,c,d,e,f,g,h,m},x] && LeQ[0,g/h-1,g/h] *)


(* ::Code:: *)
(* Int[(c_.+d_.*x_)^m_.*F_^(g_.*(e_.+f_.*x_))/(a_+b_.*F_^(h_.*(e_.+f_.*x_))),x_Symbol] :=
  1/a \[Star] Int[(c+d*x)^m*F^(g*(e+f*x)),x] - 
  b/a \[Star] Int[(c+d*x)^m*F^((g+h)*(e+f*x))/(a+b*F^(h*(e+f*x))),x] /;
...
(* ::Code:: *)
Int[F_^(d_.*(c_.*(a_.+b_.*x_)^n_)^m_),x_Symbol] :=
