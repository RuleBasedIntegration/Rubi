...
Int[((a_.) + (b_.)*Sech[u_])^(p_.), x_Symbol] := Int[(a + b*Sech[ExpandToSum[u, x]])^p, x] /; FreeQ[{a, b, p}, x] && BinomialQ[u, x] &&  !BinomialMatchQ[u, x]
Int[((a_.) + (b_.)*Csch[u_])^(p_.), x_Symbol] := Int[(a + b*Csch[ExpandToSum[u, x]])^p, x] /; FreeQ[{a, b, p}, x] && BinomialQ[u, x] &&  !BinomialMatchQ[u, x]
...
Int[((e_)*(x_))^(m_.)*((a_.) + (b_.)*Sech[u_])^(p_.), x_Symbol] := Int[(e*x)^m*(a + b*Sech[ExpandToSum[u, x]])^p, x] /; FreeQ[{a, b, e, m, p}, x] && BinomialQ[u, x] &&  !BinomialMatchQ[u, x]
Int[((e_)*(x_))^(m_.)*((a_.) + (b_.)*Csch[u_])^(p_.), x_Symbol] := Int[(e*x)^m*(a + b*Csch[ExpandToSum[u, x]])^p, x] /; FreeQ[{a, b, e, m, p}, x] && BinomialQ[u, x] &&  !BinomialMatchQ[u, x]
