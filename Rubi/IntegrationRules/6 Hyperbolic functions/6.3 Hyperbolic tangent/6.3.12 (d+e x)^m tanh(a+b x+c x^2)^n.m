...
(* Int[x_^m_*Tanh[a_.+b_.*x_+c_.*x_^2],x_Symbol] :=
  ...
  b/(2*c) \[Star] Int[x^(m-1)*Tanh[a+b*x+c*x^2],x] -
  (m-1)/(2*c) \[Star] Int[x^(m-2)*Log[Cosh[a+b*x+c*x^2]],x] /;
...
(* Int[x_^m_*Coth[a_.+b_.*x_+c_.*x_^2],x_Symbol] :=
  ...
  b/(2*c) \[Star] Int[x^(m-1)*Coth[a+b*x+c*x^2],x] -
  (m-1)/(2*c) \[Star] Int[x^(m-2)*Log[Sinh[a+b*x+c*x^2]],x] /;
FreeQ[{a,b,c},x] && GtQ[m,1] *)
