...
Int[((a_.) + (b_.)*Tanh[u_])^(p_.), x_Symbol] := Int[(a + b*Tanh[ExpandToSum[u, x]])^p, x] /; FreeQ[{a, b, p}, x] && BinomialQ[u, x] &&  !BinomialMatchQ[u, x]
Int[((a_.) + (b_.)*Coth[u_])^(p_.), x_Symbol] := Int[(a + b*Coth[ExpandToSum[u, x]])^p, x] /; FreeQ[{a, b, p}, x] && BinomialQ[u, x] &&  !BinomialMatchQ[u, x]
...
Int[((e_)*(x_))^(m_.)*((a_.) + (b_.)*Tanh[u_])^(p_.), x_Symbol] := Int[(e*x)^m*(a + b*Tanh[ExpandToSum[u, x]])^p, x] /; FreeQ[{a, b, e, m, p}, x] && BinomialQ[u, x] &&  !BinomialMatchQ[u, x]
Int[((e_)*(x_))^(m_.)*((a_.) + (b_.)*Coth[u_])^(p_.), x_Symbol] := Int[(e*x)^m*(a + b*Coth[ExpandToSum[u, x]])^p, x] /; FreeQ[{a, b, e, m, p}, x] && BinomialQ[u, x] &&  !BinomialMatchQ[u, x]
