...
(* ::Code:: *)
Int[(a_.+b_.*x_)*Sqrt[c_+d_.*x_]/Sqrt[e_+f_.*x_],x_] :=
...
(* ::Code:: *)
Int[(a_.+b_.*x_)^2*(c_.+d_.*x_)^n_*(e_.+f_.*x_)^p_,x_] :=
...
(* ::Code:: *)
Int[(a_.+b_.*x_)^m_*(c_.+d_.*x_)^n_*(f_.*x_)^p_,x_] :=
...
(* ::Code:: *)
Int[(e_.+f_.*x_)^p_/((a_.+b_.*x_)*(c_.+d_.*x_)),x_] :=
...
(* ::Code:: *)
Int[(c_.+d_.*x_)^n_*(e_.+f_.*x_)^p_/(a_.+b_.*x_),x_] :=
...
(* ::Code:: *)
Int[1/((a_.+b_.*x_)^(1/3)*(c_.+d_.*x_)^(2/3)*(e_.+f_.*x_)),x_] :=
...
(* ::Code:: *)
Int[1/((a_.+b_.*x_)*Sqrt[c_.+d_.*x_]*(e_.+f_.*x_)^(1/4)),x_] :=
...
(* ::Code:: *)
Int[1/((a_.+b_.*x_)*Sqrt[c_.+d_.*x_]*(e_.+f_.*x_)^(3/4)),x_] :=
...
(* ::Code:: *)
(* Int[Sqrt[e_.+f_.*x_]/(Sqrt[a_+b_.*x_]*Sqrt[c_+d_.*x_]),x_] :=
...
(* ::Code:: *)
Int[1/(Sqrt[b_.*x_]*Sqrt[c_+d_.*x_]*Sqrt[e_+f_.*x_]),x_] :=
...
(* ::Code:: *)
Int[1/(Sqrt[a_+b_.*x_]*Sqrt[c_+d_.*x_]*Sqrt[e_+f_.*x_]),x_] :=
...
(* ::Code:: *)
Int[1/((a_.+b_.*x_)*(c_.+d_.*x_)^(1/3)*(e_.+f_.*x_)^(1/3)),x_] :=
...
(* ::Code:: *)
Int[(a_.+b_.*x_)^m_/((c_.+d_.*x_)^(1/3)*(e_.+f_.*x_)^(1/3)),x_] :=
...
(* ::Code:: *)
(* Int[(a_.+b_.*x_)^m_*(c_.+d_.*x_)^n_*(f_.*x_)^p_,x_] :=
  Simp[(a+b*x)^m*(c+d*x)^m/(a*c+b*d*x^2)^m] \[Star] Int[(a*c+b*d*x^2)^m*(f*x)^p,x] /;
...
(* ::Code:: *)
Int[(a_.+b_.*x_)^m_*(c_.+d_.*x_)^n_/(e_.+f_.*x_)^2,x_] :=
